...
export default class User extends Component {
  render () {
    var { user, hideAvatar, onAvatarChange, editable, hideText, isRound, avatarSize, timestamp, timestampLink, className } = this.props;
    var render = {};
    ...
    if(editable) {
      render.changeAvatar = (<ChangeAvatar onChange={onAvatarChange} current_user={user} />);
    }
